...
@Client.on_message(command(["مبرمج السورس", f"صلاح", f"ورس", f"السورس", f"مطور", f"المطور"]) & filters.group & ~filters.edited)
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/3a62bb9d490376599d0b2.png",
        caption=f"""Salah Siria [Diamond](https://t.me/CR_T2) 𖡼\nᴛᴏ ⌔ سورس الماس ميوزك\n⌔ افضل سورس ميوزك وحمايه على التليجرام""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
