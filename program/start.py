...
@Client.on_message(command(["مبرمج السورس", f"صلاح", f"سورس", f"السورس", f"مطور", f"المطور"]) & filters.group & ~filters.edited)
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/3a62bb9d490376599d0b2.png",
        caption=f"""[Salah Siria](https://t.me/CR_T2) 𖡼\n⌔ سورس الماس ميوزك\n⌔ افضل سورس ميوزك وحمايه على التليجرام""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        photo=f"{DEV_PHOTO}",
        caption=f"""⌔ مطور سورس الماس ميوزك""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("Salah Siria", url=f"https://t.me/BK_ZT"),
            ]
         ]
     )
  )
